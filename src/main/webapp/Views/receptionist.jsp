...
<body>
  <div class="app-shell">
    ...
    <aside class="sidebar d-none d-lg-flex">
      ...
      <nav class="sb-nav">
        <a class="sb-link sb-active" href="<%= ctx %>/Views/receptionist.jsp"><i class="bi bi-grid-1x2-fill"></i><span>Dashboard</span></a>
    ...
    <main class="main">
      ...
      <header class="topbar">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <div class="top-title">
              Welcome back, <span class="welcome-name" id="welcomeName"><%= receptionistName %></span>
            </div>
      ...
      <section class="hero-wrap">
        ...
        <div class="hero-content">
          <div class="hero-badge"><i class="bi bi-stars"></i>Receptionist Dashboard</div>

          <h2 class="hero-title">Ocean View Resort Front Desk</h2>


          <div class="quick-actions">
            <a class="btn btn-primary qa-btn" href="<%= ctx %>/ReceptionistReservationsServlet">
              <i class="bi bi-journal-text me-1"></i>Reservations
            </a>
            <a class="btn btn-outline-primary qa-btn" href="<%= ctx %>/Views/receptionist/guest.jsp">
              <i class="bi bi-people me-1"></i>Customers
            </a>
            <a class="btn btn-outline-dark qa-btn" href="<%= ctx %>/Views/receptionist/checkout.jsp">
